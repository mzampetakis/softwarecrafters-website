...
('undefined' == typeof jQuery &&
  ('function' == typeof require ? (jQuery = $ = require('jquery')) : (jQuery = $)),
  (function (t) {
      ...
      (function (t) {
        ...
        return (function (t, e, i, n) {
              ...
              for (var a = 0; i > a; a++)
                if (b.State.calls[a]) {
                  ...
                  for (var g = Math.min((e - h) / c.duration, 1), y = 0, w = l.length; w > y; y++) {
                    ...
                    if (r(T)) {
                      ...
                      for (var A in x)
                        if ('element' !== A) {
                          ...
                          if (1 === g) O = E.endValue;
                            ...
                            if (((O = E.startValue + M * _(g, c, M)), !f && O === E.currentValue))
                              continue;
                          }
                          if (((E.currentValue = O), 'tween' === A)) m = O;
                            ...
                            var q = k.setPropertyValue(
                              T,
                              A,
                              E.currentValue + (0 === parseFloat(O) ? '' : E.unitType),
                              E.rootPropertyValue,
                              E.scrollData
                            );
                            (k.Hooks.registered[A] &&
                              (r(T).rootPropertyValueCache[I] = k.Normalizations.registered[I]
                                ? k.Normalizations.registered[I]('extract', null, q[1])
                                : q[1]),
                              'transform' === q[0] && (S = !0));
                          }
                        }
                      (c.mobileHA &&
                        ...
                        ((r(T).transformCache.translate3d = '(0px, 0px, 0px)'), (S = !0)),
                  ...
                  (c.display !== n && 'none' !== c.display && (b.State.calls[a][2].display = !1),
                    ...
                    c.progress &&
                      c.progress.call(s[1], s[1], g, Math.max(0, h + c.duration - e), h, m),
                    1 === g && d(a));
                }
            }
          ...
          function d(t, e) {
            ...
            for (
              ...
              if (
                (e ||
                  a.loop ||
                  ('none' === a.display && k.setPropertyValue(d, 'display', a.display),
                  'hidden' === a.visibility && k.setPropertyValue(d, 'visibility', a.visibility)),
                !0 !== a.loop &&
                  (p.queue(d)[1] === n || !/\.velocityQueueEntryFlag/i.test(p.queue(d)[1])) &&
                  r(d))
              ) {
                ...
                (p.each(k.Lists.transforms3D, function (t, e) {
                  ...
                  a.mobileHA && ((h = !0), delete r(d).transformCache.translate3d),
          ...
          var p,
            ...
            m = !1;
          if (
            (t.fn && t.fn.jquery ? ((p = t), (m = !0)) : (p = e.Velocity.Utilities), 8 >= h && !m)
          )
            throw new Error('Velocity: IE8 and below require jQuery to be loaded before Velocity.');
          {
            if (!(7 >= h)) {
              ...
              e.pageYOffset !== n
                ...
                : ((b.State.scrollAnchor = i.documentElement || i.body.parentNode || i.body),
                ...
                return function t(e, n, o) {
                  ...
                  for (
                    e = parseFloat(e) || 500,
                      ...
                      l.tension = e,
                      l.friction = n,
                      (a = null !== o) ? ((u = t(e, n)), (r = (u / o) * 0.016)) : (r = 0.016);
                    (s = i(s || l, r)),
                      c.push(1 + s.x),
                      (u += 16),
              ...
              var k = (b.CSS = {
                ...
                Hooks: {
                  ...
                  cleanRootPropertyValue: function (t, e) {
                    return (
                      k.RegEx.valueUnwrap.test(e) && (e = e.match(k.RegEx.valueUnwrap)[1]),
                              ...
                              if (k.RegEx.wrappedValueAlreadyExtracted.test(o)) a = o;
                                ...
                                (/^[A-z]+$/i.test(o)
                                  ...
                                  : k.RegEx.isHex.test(o)
                                    ? (r = 'rgb(' + k.Values.hexToRgb(o).join(' ') + ')')
                ...
                Names: {
                  ...
                  SVGAttribute: function (t) {
                    ...
                    return (
                      (h || (b.State.isAndroid && !b.State.isChrome)) && (e += '|transform'),
                  ...
                  removeClass: function (t, e) {
                    t.classList
                      ...
                      : (t.className = t.className
                          .toString()
                          .replace(
                            new RegExp('(^|\\s)' + e.split(' ').join('|') + '(\\s|$)', 'gi'),
                            ' '
                          ));
                  },
                },
                getPropertyValue: function (t, i, o, a) {
                  function s(t, i) {
                    ...
                    if (8 >= h) l = p.css(t, i);
                      ...
                      if (
                        (/^(width|height)$/.test(i) &&
                          ...
                          ((c = !0), k.setPropertyValue(t, 'display', k.Values.getDisplayType(t))),
                        !a)
                      ) {
                        if (
                          'height' === i &&
                          'border-box' !==
                            k.getPropertyValue(t, 'boxSizing').toString().toLowerCase()
                        ) {
                          var u =
                            t.offsetHeight -
                            (parseFloat(k.getPropertyValue(t, 'borderTopWidth')) || 0) -
                            (parseFloat(k.getPropertyValue(t, 'borderBottomWidth')) || 0) -
                            (parseFloat(k.getPropertyValue(t, 'paddingTop')) || 0) -
                            (parseFloat(k.getPropertyValue(t, 'paddingBottom')) || 0);
                          return (o(), u);
                        }
                        if (
                          'width' === i &&
                          ...
                          var d =
                            t.offsetWidth -
                            (parseFloat(k.getPropertyValue(t, 'borderLeftWidth')) || 0) -
                            (parseFloat(k.getPropertyValue(t, 'borderRightWidth')) || 0) -
                            (parseFloat(k.getPropertyValue(t, 'paddingLeft')) || 0) -
                            (parseFloat(k.getPropertyValue(t, 'paddingRight')) || 0);
                          return (o(), d);
                        }
                      }
                      var f;
                    ...
                    if ('auto' === l && /^(top|right|bottom|left)$/i.test(i)) {
                      var v = s(t, 'position');
                      ('fixed' === v || ('absolute' === v && /top|left/i.test(i))) &&
                        (l = p(t).position()[i] + 'px');
                    }
                    return l;
                  }
                  ...
                  if (k.Hooks.registered[i]) {
                    ...
                    var d, f;
                    ('transform' !== (d = k.Normalizations.registered[i]('name', t)) &&
                  ...
                  if ('scroll' === i)
                    ...
                    if (
                      ...
                      try {
                        ...
                        b.debug &&
                          console.log('Browser does not support [' + n + '] for [' + s + ']');
                      }
                    else
                ...
                flushTransformCache: function (t) {
                  ...
                  if ((h || (b.State.isAndroid && !b.State.isChrome)) && r(t).isSVG) {
                    var n = {
                      ...
                      skewY: [e('skewY')],
                      scale:
                        1 !== e('scale') ? [e('scale'), e('scale')] : [e('scaleX'), e('scaleY')],
                    ...
                    (p.each(r(t).transformCache, function (e) {
                      return (
                        ...
                        'transformPerspective' === e
                          ? ((a = o), !0)
                          : (9 === h && 'rotateZ' === e && (e = 'rotate'), void (i += e + o + ' '))
                      );
                    }),
                      a && (i = 'perspective' + a + ' ' + i));
                  }
                        ...
                        v.isArray(t)
                          ? ((i = t[0]),
                            ...
                            k.RegEx.isHex.test(t[1])
                              ? (r = t[1])
                              : ((v.isString(t[1]) && !k.RegEx.isHex.test(t[1])) ||
                                  v.isArray(t[1])) &&
                                ((o = e ? t[1] : c(t[1], s.duration)), t[2] !== n && (r = t[2])))
                          : (i = t),
                        e || (o = o || s.easing),
                    ...
                    if ('scroll' === A) {
                      ...
                      (s.container
                        ? v.isWrapped(s.container) || v.isNode(s.container)
                          ...
                          : (s.container = null)
                        : ((g = b.State.scrollAnchor[b.State['scrollProperty' + S]]),
                          (w =
                            b.State.scrollAnchor[
                              b.State['scrollProperty' + ('Left' === S ? 'Top' : 'Left')]
                            ]),
                      ...
                      for (var E in M)
                        if ('element' !== E) {
                          ...
                          ((M[E].startValue = M[E].currentValue = M[E].endValue),
                            ...
                            b.debug &&
                              console.log(
                                'reverse tweensContainer (' + E + '): ' + JSON.stringify(M[E]),
                                a
                              ));
                        }
                      l = M;
                      ...
                      for (var q in m) {
                        ...
                        if (
                          ...
                          (((s.display !== n && null !== s.display && 'none' !== s.display) ||
                            (s.visibility !== n && 'hidden' !== s.visibility)) &&
                          ...
                          if (
                            ...
                            if (0 === V) W = F;
                              ...
                              o =
                                ...
                                (function () {
                                  var t = {
                                    ...
                                    n =
                                      t.position === I.lastPosition && t.myParent === I.lastParent,
                                  ...
                                  if (o && n)
                                    ...
                                    (b.init(c),
                                      ...
                                      (l.percentToPxWidth = I.lastPercentToPxWidth =
                                        (parseFloat(k.getPropertyValue(c, 'width', null, !0)) ||
                                          1) / s),
                                      (l.percentToPxHeight = I.lastPercentToPxHeight =
                                        (parseFloat(k.getPropertyValue(c, 'height', null, !0)) ||
                                          1) / s),
                                      (l.emToPx = I.lastEmToPx =
                                        (parseFloat(k.getPropertyValue(c, 'paddingLeft')) || 1) /
                                        s),
                                  ...
                                  return (
                                    null === I.remToPx &&
                                      (I.remToPx =
                                        parseFloat(k.getPropertyValue(i.body, 'fontSize')) || 16),
                                    null === I.vwToPx &&
                                      ((I.vwToPx = parseFloat(e.innerWidth) / 100),
                              ...
                              var X =
                                /margin|padding|left|right|width|text|word|letter/i.test(q) ||
                                /X$/.test(q) ||
                                'x' === q
                                  ? 'x'
                                  : 'y';
                          ...
                          ((l[q] = {
                            ...
                            b.debug &&
                              console.log(
                                'tweensContainer (' + q + '): ' + JSON.stringify(l[q]),
                                a
                              ));
                        } else
                          b.debug &&
                            console.log('Skipping [' + j + '] due to a lack of browser support.');
                      }
                      l.element = a;
                    }
                    l.element &&
                      ...
                      D.push(l),
                      '' === s.queue && ((r(a).tweensContainer = l), (r(a).opts = s)),
                      (r(a).isAnimating = !0),
                      T === C - 1
                        ? (b.State.calls.push([D, f, s, null, P.resolver]),
                          !1 === b.State.isTicking && ((b.State.isTicking = !0), u()))
                        : T++);
                  }
                  var o,
                    a = this,
                ...
                if (
                  ...
                  if (!/^(stop|finish)$/i.test(m) && !p.isPlainObject(y)) {
                    ...
                    for (var S = h + 1; S < arguments.length; S++)
                      ...
                      (!/^(fast|normal|slow)$/i.test(arguments[S]) && !/^\d/.test(arguments[S]))
                        ? v.isString(arguments[S]) || v.isArray(arguments[S])
                          ? (y.easing = arguments[S])
                          : v.isFunction(arguments[S]) && (y.complete = arguments[S])
                        ...
                        p.each(b.State.calls, function (t, e) {
                          e &&
                            p.each(e[1], function (i, o) {
                              var a = y === n ? '' : y;
                              return (
                                (!0 !== a && e[2].queue !== a && (y !== n || !1 !== e[2].queue)) ||
                                void p.each(f, function (i, n) {
                                  n === o &&
                                    ((!0 === y || v.isString(y)) &&
                                      (p.each(p.queue(n, v.isString(y) ? y : ''), function (t, e) {
                                    ...
                                    'stop' === m
                                      ? (r(n) &&
                                          r(n).tweensContainer &&
                                          !1 !== a &&
                                          p.each(r(n).tweensContainer, function (t, e) {
                      ...
                      if (!p.isPlainObject(m) || v.isEmptyObject(m)) {
                        if (v.isString(m) && b.Redirects[m]) {
                          var E = (z = p.extend({}, y)).duration,
                            _ = z.delay || 0;
                          return (
                            !0 === z.backwards && (f = p.extend(!0, [], f).reverse()),
                            p.each(f, function (t, e) {
                              (parseFloat(z.stagger)
                                ...
                                z.drag &&
                                  ((z.duration =
                                    parseFloat(E) || (/^(callout|transition)/.test(m) ? 1e3 : g)),
                                  (z.duration = Math.max(
                                    z.duration * (z.backwards ? 1 - t / C : (t + 1) / C),
                                    0.75 * z.duration,
                                    200
                                  ))),
  ...
  (function (t, e, i, n) {
    ...
    (t.MSPointerEvent &&
      ((Nt = 'MSPointerDown'), (Wt = 'MSPointerMove MSPointerUp MSPointerCancel')),
      c(j, T, {
        handler: function (t) {
          var e = this.store,
            i = !1,
...
Materialize.throttle = function (t, e, i) {
  ...
  return function () {
    ...
    return (
      ...
      (o = arguments),
      u <= 0
        ? (clearTimeout(r), (r = null), (s = c), (a = t.apply(n, o)), (n = o = null))
...
((Vel = jQuery ? jQuery.Velocity : $ ? $.Velocity : Velocity),
        ...
        this.each(function () {
          ...
          function s(t) {
            t.hasClass('active')
              ...
              : 'function' == typeof e.onClose && e.onClose.call(this, t.parent());
          }
          function l(t) {
            return c(t).length > 0;
          }
  ...
  (function (t) {
    ((t.fn.scrollTo = function (e) {
      return (
        t(this).scrollTop(t(this).scrollTop() - t(this).offset().top + t(e).offset().top),
        this
      );
    }),
          ...
          : 'close' === e
            ...
            : void this.each(function () {
                ...
                function o(e) {
                  ...
                  if (
                    (b.is('body') ||
                      (b[0].scrollHeight > b[0].clientHeight && (g = b[0].scrollTop),
                  ...
                  ('left' === h
                    ...
                    c.css({ position: 'absolute', top: r.position().top + m + g, left: v + y }),
                    c
                      .slideDown({
                        queue: !1,
                    ...
                    r.on('click.' + r.attr('id'), function (e) {
                      l ||
                        ...
                        0 !== t(e.target).closest('.dropdown-content').length
                          ? r.hasClass('active') && (a(), t(document).off('click.' + c.attr('id')))
                          : (e.preventDefault(),
                ...
                value: function () {
                  ...
                  (t.extend(this.$el[0].style, { display: 'block', opacity: 0 }),
                    ...
                    e(
                      ...
                      { duration: this.options.inDuration, queue: !1, ease: 'easeOutCubic' }
                    ));
                  var n = {
                  ...
                  this.$el[0].classList.contains('bottom-sheet')
                    ...
                    : (e.hook(this.$el[0], 'scaleX', 0.7),
                      ...
                      e(this.$el[0], { top: this.options.endingTop, opacity: 1, scaleX: 1 }, n));
                },
              },
              {
                key: 'animateOut',
                value: function () {
                  ...
                  e(
                    this.$overlay[0],
                    { opacity: 0 },
                    { duration: this.options.outDuration, queue: !1, ease: 'easeOutQuart' }
                  );
                  var i = {
                  ...
                  this.$el[0].classList.contains('bottom-sheet')
                    ...
                    : e(this.$el[0], { top: this.options.startingTop, opacity: 0, scaleX: 0.7 }, i);
                },
              },
              {
                key: 'open',
          ...
          (s.velocity('stop', !0),
            ...
            s.velocity(
              { width: n, height: l, left: 0, top: 0 },
              {
                ...
                easing: 'easeOutQuad',
                complete: function () {
                  (e.css({ height: '', width: '', position: '', top: '', left: '' }),
                    s.removeAttr('style'),
                    s.attr('style', c),
            ...
            s.on('click', function () {
              ...
              for (; null !== n && !t(n).is(document); ) {
                ...
                ('visible' !== p.css('overflow') &&
                  (p.css('overflow', 'visible'), (i = void 0 === i ? p : i.add(p))),
                  (n = n.parentNode));
              }
              s.css({
                position: 'absolute',
              ...
              if (
                (h.css({ width: l, height: c, left: -1 * f.left, top: -1 * f.top }),
                h.velocity({ opacity: 1 }, { duration: 275, queue: !1, easing: 'easeOutQuad' }),
                '' !== s.data('caption'))
              ) {
                ...
                (v.text(s.data('caption')),
                  ...
                  v.velocity({ opacity: 1 }, { duration: 275, queue: !1, easing: 'easeOutQuad' }));
              }
              var m = 0,
                g = 0;
              (u / l > d / c
      ...
      init: function (e) {
        ...
        return this.each(function (i) {
          var o,
            ...
            b = function (t) {
              return Math.ceil(
                h - t.position().left - t[0].getBoundingClientRect().width - u.scrollLeft()
              );
            },
            w = function (t) {
            ...
            k = function (t) {
              m - t >= 0
                ? (s.velocity({ right: b(o) }, { duration: 300, queue: !1, easing: 'easeOutQuad' }),
                  s.velocity(
                    { left: w(o) },
                    { duration: 300, queue: !1, easing: 'easeOutQuad', delay: 90 }
                  ))
                : (s.velocity({ left: w(o) }, { duration: 300, queue: !1, easing: 'easeOutQuad' }),
                  s.velocity(
                    { right: b(o) },
                    { duration: 300, queue: !1, easing: 'easeOutQuad', delay: 90 }
                  ));
            ...
            t(window)
              ...
              .on('resize.tabs-' + c, function () {
                ((h = u.width()),
                  (v = Math.max(h, u[0].scrollWidth) / p.length),
                  m < 0 && (m = 0),
                  0 !== v && 0 !== h && (s.css({ right: b(o) }), s.css({ left: w(o) })));
              }),
            e.swipeable
              ? (p.each(function () {
                ...
                (o.addClass('active'),
                  ...
                  e.swipeable
                    ...
                    : (void 0 !== a &&
                      ...
                      void 0 === n || n.is(a) || (n.hide(), n.removeClass('active'))),
  ...
  (function (t) {
        ...
        : ((i = t.extend(n, i)),
          this.each(function () {
            ...
            ((c = (function () {
              ...
              return (
                (l = a ? t('<span></span>').html(l) : t('<span></span>').text(l)),
              ...
              'mouseenter.tooltip': function (t) {
                p = setTimeout(function () {
                  ...
                  ('top' === s
                    ...
                    (w = Math.max(y, b)),
                    c
                      .velocity({ translateY: f, translateX: v }, { duration: 350, queue: !1 })
                      .velocity({ opacity: 1 }, { duration: 300, delay: 50, queue: !1 }),
                    u
                      .css({ visibility: 'visible' })
                      .velocity({ opacity: 1 }, { duration: 55, delay: 0, queue: !1 })
                      .velocity(
                        { scaleX: w, scaleY: w },
                        { duration: 300, delay: 0, queue: !1, easing: 'easeInOutQuad' }
                      ));
                }, r);
              },
    ...
    var e = function (e, i, n, o) {
      var a = e,
        r = i;
      return (
        a < 0 ? (a = 4) : a + n > window.innerWidth && (a -= a + n - window.innerWidth),
        r < 0
          ? (r = 4)
          : r + o > window.innerHeight + t(window).scrollTop && (r -= r + o - window.innerHeight),
        { x: a, y: r }
      );
    };
    t(document).ready(function () {
  ...
  (function (t) {
    ...
    function n(t) {
      ...
      return (
        ...
        (n = i(a)),
        { top: o.top + n.pageYOffset - e.clientTop, left: o.left + n.pageXOffset - e.clientLeft }
      );
    }
    function o(t) {
      var e = '';
    ...
    var s = s || {},
      ...
      c = {
        ...
        show: function (t, e) {
          ...
          ('touches' in t && ((s = t.touches[0].pageY - r.top), (l = t.touches[0].pageX - r.left)),
    ...
    ((s.displayEffect = function (e) {
      ...
      (s.attach = function (e) {
        ('input' === e.tagName.toLowerCase() && (c.wrapInput([e]), (e = e.parentNode)),
      ...
      n = (function () {
        function n(e, i, o, a) {
          if ((_classCallCheck(this, n), e)) {
            ((this.options = { displayLength: i, className: o, completeCallback: a }),
        ...
        ((e = t.extend(i, e)),
          t(this).each(function () {
            ...
            (e.draggable
              ...
              !0 === e.closeOnClick &&
                o.on('click.itemclick', 'a:not(.collapsible-header)', function () {
  ...
  (function (t) {
    (t(document).ready(function () {
      ...
      (t(document).on('change', i, function () {
        ((0 === t(this).val().length && void 0 === t(this).attr('placeholder')) ||
      ...
      (t(document).on('change', o, function (e) {
        ...
        t(document).on('mousedown touchstart', o, function (e) {
          ...
          if (
            (i.length <= 0 &&
              ((i = t('<span class="thumb"><span class="value"></span></span>')), t(this).after(i)),
          ...
          return (
            ...
            this.each(function () {
              ...
              if (t.isEmptyObject(o)) n.off('keyup.autocomplete focus.autocomplete');
                ...
                (s.length
                  ? (l = s.children('.autocomplete-content.dropdown-content').first()).length ||
                    s.append(c)
                  : (l = n.next('.autocomplete-content.dropdown-content')).length || n.after(c),
                  l.length && (c = l));
                var u = function (t, e) {
                    var i = e.find('img'),
                      n = e
                      ...
                      s = e.text().slice(o + 1);
                    (e.html(
                      '<span>' + a + "<span class='highlight'>" + r + '</span>' + s + '</span>'
                    ),
                  ...
                  n.off('keydown.autocomplete').on('keydown.autocomplete', function (t) {
                    ...
                    13 === i && r >= 0
                      ? (e = c.children('li').eq(r)).length &&
                        (e.trigger('mousedown.autocomplete'), t.preventDefault())
                      : (38 !== i && 40 !== i) ||
                        (t.preventDefault(),
                        38 === i && r > 0 && r--,
                        40 === i && r < n - 1 && r++,
            ...
            (c.length &&
              c.each(function () {
                if (t(this).is('option')) o ? h(0, t(this), 'multiple') : h(0, t(this));
                  ...
                  (l.append(
                    t('<li class="optgroup"><span>' + t(this).attr('label') + '</span></li>')
                  ),
                    e.each(function () {
                ...
                focus: function () {
                  if (
                    (t('ul.select-dropdown').not(l[0]).is(':visible') &&
                      (t('input.select-dropdown').trigger('close'), t(window).off('click.select')),
                    !l.is(':visible'))
                  ) {
                ...
                if (40 != e.which || l.is(':visible')) {
                  if (13 != e.which || l.is(':visible')) {
                    ...
                    (40 == e.which &&
                      ...
                      38 == e.which &&
                        (r = l.find('li.selected').prev('li:not(.disabled)')[0]) &&
                        g(l, r),
                      setTimeout(function () {
                        y = [];
                      }, 1e3));
          ...
          this.each(function () {
            ...
            (-1 != u && (o = c.eq(u)),
              s.hasClass('fullscreen') ||
                (e.indicators ? s.height(e.height + 40) : s.height(e.height), l.height(e.height)),
              ...
              c.find('img').each(function () {
                ...
                t(this).attr('src') !== e &&
                  (t(this).css('background-image', 'url("' + t(this).attr('src') + '")'),
                  t(this).attr('src', e));
              }),
              e.indicators &&
                ...
                if ('touch' === t.gesture.pointerType) {
                  ...
                  (($curr_slide = l.find('.active')),
                    ...
                    4 === e && (i > s.innerWidth() / 2 || n < -0.65)
                      ? (h = !0)
                      : 2 === e && (i < (-1 * s.innerWidth()) / 2 || n > 0.65) && (p = !0));
                  var a;
                  (p &&
      ...
      (t.fn.material_chip = function (i) {
        ...
        ((n.hasAutocomplete = !t.isEmptyObject(o.autocompleteOptions.data)),
                ...
                if (!t(i.target).is('input, textarea')) {
                  ...
                  if (a.length)
                    if (8 === i.which || 46 === i.which) {
                      ...
                      if (((o = a.index() + 1), t(e.CHIP).removeClass('selected'), o > s))
                ...
                .on('keydown.chips-add', e.CHIPS + ' ' + e.INPUT, function (i) {
                  ...
                  if (13 === i.which) {
                    if (
                      ...
                      a.find('.autocomplete-content.dropdown-content').children().length
                    )
                      return;
                    return (i.preventDefault(), n.addChip({ tag: o.val() }, a), void o.val(''));
                  }
                  if ((8 === i.keyCode || 37 === i.keyCode) && '' === o.val() && r)
                    return (i.preventDefault(), n.selectChip(r - 1, a), void o.blur());
                }),
              n.$document
                .off('click.chips-delete', e.CHIPS + ' ' + e.DELETE)
                .on('click.chips-delete', e.CHIPS + ' ' + e.DELETE, function (i) {
                  var o = t(i.target),
                    a = o.closest(e.CHIPS),
                    r = o.closest(e.CHIP);
          ...
          (this.setPlaceholder = function (t) {
            void 0 !== t.data('chips') && !t.data('chips').length && o.placeholder
          ...
          (this.selectChip = function (t, e) {
            ...
            i &&
              ...
              (i.addClass('selected'), e.trigger('chip.select', e.data('chips')[t]));
          }),
            ...
            function n(n, o) {
              n.each(function () {
                (e.top <= o &&
                  ...
                  (i(t(this)), t(this).css('top', e.offset), t(this).addClass('pinned')),
                  o < e.top &&
                    !t(this).hasClass('pin-top') &&
                    (i(t(this)), t(this).css('top', 0), t(this).addClass('pin-top')),
                  o > e.bottom &&
                    !t(this).hasClass('pin-bottom') &&
                    (i(t(this)), t(this).addClass('pin-bottom'), t(this).css('top', e.bottom - r)));
              });
            }
        ...
        if (!1 === i.hasClass('active')) {
          ...
          (!0 === i.hasClass('horizontal') ? (o = 40) : (n = 40),
            ...
            i
              ...
              .velocity(
                { scaleY: '.4', scaleX: '.4', translateY: n + 'px', translateX: o + 'px' },
                { duration: 0 }
              ));
          var a = 0;
      ...
      n = function (e) {
        if ('true' !== e.attr('data-open')) {
          ...
          (c.append(d),
            ...
            c.css({ transform: 'translateY(' + -n + 'px)', transition: 'none' }),
            ...
            setTimeout(function () {
              (e.css({
                ...
                c.css({ overflow: 'visible', transform: '', transition: 'transform .2s' }),
                setTimeout(function () {
          ...
          ((e = s - n / 2 + a / 2),
            ...
            setTimeout(function () {
              (u.remove(),
                ...
                l.css({ overflow: '', transform: 'translate3d(0,' + i + 'px,0)' }),
                setTimeout(function () {
                  (t.css({ transform: 'translate3d(0,0,0)', transition: 'transform .2s' }),
                    l.css({
          ...
          t(this)
            ...
            .on('pan', function (n) {
              if ('touch' === n.gesture.pointerType) {
                ...
                (o.velocity({ translateX: r }, { duration: 50, queue: !1, easing: 'easeOutQuad' }),
                  4 === a && (r > o.innerWidth() / 2 || s < -0.75) && (e = !0),
                  2 === a && (r < (-1 * o.innerWidth()) / 2 || s > 0.75) && (i = !0));
              }
            })
            .on('panend', function (n) {
              if (
                (Math.abs(n.gesture.deltaX) < t(this).innerWidth() / 2 && ((i = !1), (e = !1)),
  ...
  (function (t) {
    ...
    Materialize.scrollFire = function (t) {
      ...
      (e || (window.addEventListener('scroll', n), window.addEventListener('resize', n), (e = !0)),
        setTimeout(n, 0));
    };
  })(jQuery),
  (function (t) {
    ...
    function e(a, s, u, d) {
      function p() {
        return e._.node(
          ...
          e._.node(
            'div',
            e._.node('div', e._.node('div', T.component.nodes(b.open), k.box), k.wrap),
            k.frame
          ),
          k.holder
        );
        ...
        (x
          ...
          w.editable ||
            x
              ...
              .on('keydown.' + b.id, m),
          o(a, { haspopup: !0, expanded: !1, readonly: !1, owns: a.id + '_root' }));
      }
      function f() {
        (T.$root
          .on({
          ...
          .on('click', '[data-pick], [data-nav], [data-clear], [data-close]', function () {
            ...
            ((o = o && (o.type || o.href) && o),
              ...
              !n && i.nav
                ? T.set('highlight', T.component.item.highlight, { nav: i.nav })
                : !n && 'pick' in i
      ...
      function m(t) {
        ...
        (32 == e || i || (!b.open && T.component.key[e])) &&
          (t.preventDefault(), t.stopPropagation(), i ? T.clear().close() : T.open());
      }
      function g(t) {
      ...
      var y = !1,
        ...
        T = (C.prototype = {
          ...
          start: function () {
            return b && b.start
              ...
              : ((b.methods = {}),
                ...
                (T.$root = t(
                  e._.node('div', p(), k.picker, 'id="' + a.id + '_root" tabindex="0"')
                )),
                f(),
                w.formatSubmit && v(),
                h(),
          ...
          render: function (t) {
            return (
              t ? T.$root.html(p()) : T.$root.find('.' + k.box).html(T.component.nodes(b.open)),
              T.trigger('render')
            );
          },
          stop: function () {
                  ...
                  l
                    ...
                    .on('keydown.' + b.id, function (i) {
                      ...
                      27 == n
                        ? T.close(!0)
                        : a != T.$root[0] || (!o && 13 != n)
                          ? t.contains(T.$root[0], a) && 13 == n && (i.preventDefault(), a.click())
                          : (i.preventDefault(),
                            o
                              ? e._.trigger(T.component.key.go, T, [e._.trigger(o)])
                              : T.$root.find('.' + k.highlighted).hasClass(k.disabled) ||
          ...
          set: function (e, i, n) {
            ...
            if (((n = r && t.isPlainObject(i) ? i : n || {}), e)) {
              ...
              for (o in s)
                ((a = s[o]),
                  o in T.component.item && (void 0 === a && (a = null), T.component.set(o, a, n)),
                  ('select' != o && 'clear' != o) ||
                    x.val('clear' == o ? '' : T.get(o, w.format)).trigger('change'));
              T.render();
            }
  ...
  (function (t) {
    ...
    function i(t, e) {
      ...
      ((i.settings = e),
        ...
        r ? i.set('select', r, { format: s }) : i.set('select', null).set('highlight', i.item.now),
        (i.key = {
          40: 7,
          38: -7,
          39: function () {
          ...
          .on(
            ...
            function () {
              (t.$root.find('.' + e.klass.selectMonth).on('change', function () {
                var i = this.value;
                i &&
                  (t.set('highlight', [t.get('view').year, i, t.get('highlight').date]),
                  t.$root.find('.' + e.klass.selectMonth).trigger('focus'));
              }),
                t.$root.find('.' + e.klass.selectYear).on('change', function () {
                  var i = this.value;
                  i &&
                    (t.set('highlight', [i, t.get('view').month, t.get('highlight').date]),
        ...
        return (
          ...
          i == -1 / 0 || i == 1 / 0
            ...
            : e.isPlainObject(i) && n.isInteger(i.pick)
              ? (i = i.obj)
              : e.isArray(i)
                ? ((i = new Date(i[0], i[1], i[2])), (i = n.isDate(i) ? i : r.create().obj))
                : (i =
                    n.isInteger(i) || n.isDate(i) ? r.normalize(new Date(i), o) : r.now(t, i, o)),
          {
      ...
      (i.prototype.createRange = function (t, i) {
        ...
        return (
          ...
          n.isInteger(t) && e.isPlainObject(i)
            ...
            : n.isInteger(i) && e.isPlainObject(t) && (i = [t.year, t.month, t.date + i]),
          { from: a(t), to: a(i) }
        );
      }),
      ...
      (i.prototype.isDateOverlap = function (t, i) {
        ...
        return n.isInteger(t) && (n.isDate(i) || e.isArray(i))
          ...
          : n.isInteger(i) && (n.isDate(t) || e.isArray(t))
            ...
            : !(!e.isPlainObject(t) || !e.isPlainObject(i)) && o.overlapRanges(t, i);
      }),
          ...
          h = function (t) {
            return n.node(
              ...
              'data-nav=' +
                (t || -1) +
                ' ' +
                n.ariaAttr({ role: 'button', controls: e.$node[0].id + '_table' }) +
                ' title="' +
                      ...
                      item: function (t) {
                        return [
                          ...
                          'value=' +
                            t +
                            (l.month == t ? ' selected' : '') +
                            ((l.year == u.year && t < u.month) || (l.year == d.year && t > d.month)
                              ? ' disabled'
                              : ''),
                        ];
                      },
        ...
        return (
          ...
          n.node(
            ...
            n.node('div', v('raw'), i.klass.year_display) +
              n.node('span', createWeekdayLabel() + ', ', 'picker__weekday-display') +
            ...
            n.node(
              ...
              n.node(
                'div',
                n.node('div', (i.selectYears, f() + v() + h() + h(1)), i.klass.header) +
                  n.node(
                    'table',
                    p +
                      n.node(
                                  ...
                                  return [
                                    n.node(
                                      ...
                                      (function (e) {
                                        return (
                                          e.push(
                                            l.month == t.month ? i.klass.infocus : i.klass.outfocus
                                          ),
                    ...
                    'id="' +
                      e.$node[0].id +
                      '_table" ' +
                      n.ariaAttr({ role: 'grid', controls: e.$node[0].id, readonly: !0 })
                  ),
  ...
  (function (t) {
    ...
    function o(o, r) {
      ...
      if (r.twelvehour)
        for (_ = 1; _ < 13; _ += 1)
          ((M = q.clone()),
            (I = (_ / 6) * Math.PI),
            (D = y),
            M.css({ left: g + Math.sin(I) * D - w, top: g - Math.cos(I) * D - w }),
            M.html(0 === _ ? '00' : _),
            m.append(M),
            M.on(p, l));
      else
      ...
      for (_ = 0; _ < 60; _ += 5)
        ((M = q.clone()),
          (I = (_ / 30) * Math.PI),
          M.css({ left: g + Math.sin(I) * y - w, top: g - Math.cos(I) * y - w }),
          M.html(i(_)),
          T.append(M),
          M.on(p, l));
      if (
    ...
    ((o.DEFAULTS = {
        ...
        if (!this.isShown) {
          ...
          if (
            (this.options.twelvehour &&
              void 0 !== o[1] &&
              (o[1].indexOf('AM') > 0 ? (this.amOrPm = 'AM') : (this.amOrPm = 'PM'),
        ...
        if (
          ...
          p.twelvehour
            ? l
              ...
              : (o && (r *= 5), 60 === r && (r = 0))
            : l
              ? (12 === r && (r = 0), (r = h ? (0 === r ? 12 : r) : 0 === r ? 0 : r + 12))
              : (o && (r *= 5), 60 === r && (r = 0)),
      ...
      (o.prototype.done = function () {
        ...
        (this.options.twelvehour && (e += this.amOrPm),
          ...
          e !== t &&
            (this.input.triggerHandler('change'), this.isInput || this.element.trigger('change')),
    ...
    var e = {
        ...
        return this.each(function (i) {
          ...
          function s(i) {
            ...
            if (
              ...
              h.index() !== p &&
                (h.removeClass('active'), V.find('.indicator-item').eq(p).addClass('active'));
            }
            for (
              (!W || (w >= 0 && w < C)) &&
                ((c = v[r(w)]),
                t(c).hasClass('active') ||
                  (j.find('.carousel-item').removeClass('active'), t(c).addClass('active')),
                (c.style[_] =
                  u +
                  ' translateX(' +
                  -a / 2 +
                  ...
                  'px)'),
                (c.style.zIndex = 0),
                e.fullWidth ? (tweenedOpacity = 1) : (tweenedOpacity = 1 - 0.2 * l),
              ...
              (e.fullWidth
                ? ((zTranslation = e.dist), (tweenedOpacity = n === o && a < 0 ? 1 - l : 1))
          ...
          function h(t) {
            var e, i;
            if (k)
              if (((e = o(t)), (y = a(t)), (i = T - e), Math.abs(S - y) < 30 && !z))
          ...
          if (
            (e.fullWidth &&
              ((e.dist = 0), Q(), N && j.find('.carousel-fixed-item').addClass('with-indicators')),
            j.hasClass('initialized'))
          )
            return (t(window).trigger('resize'), j.trigger('carouselNext', [1e-6]), !0);
          ...
          (t(window)
            ...
            t(this).on('carouselNext', function (t, e, i) {
              (void 0 === e && (e = 1),
                ...
                b !== A && ((P = A - b), (I = Date.now()), requestAnimationFrame(c)));
            }),
      ...
      destroy: function () {
        ...
        (t(this).removeAttr('data-namespace'),
          ...
          void 0 !== window.ontouchstart &&
            t(this).off('touchstart.carousel touchmove.carousel touchend.carousel'),
          t(this).off(
      ...
      init: function (e) {
        return this.each(function () {
          ...
          (o.length || (o = n.wrap(t('<div class="tap-target-wrapper"></div>')).parent()),
            s.length || ((s = t('<div class="tap-target-content"></div>')), n.append(s)),
            a.length ||
